...
public class MyAdapter3 extends RecyclerView.Adapter<Viewholder2>{
List <Model3> modelList;
     Context context;

    public MyAdapter3(List<Model3> modelList, Context context) {
